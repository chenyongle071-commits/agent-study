...
- [x] 第 7 天：实现 SSE 流式输出
- [x] 第 7 天：实现结构化 JSON 输出
- [x] 第 7 天：实现超时、重试、限流的基础版本
- [x] 第 7 天：完成周验收：带数据库、历史记录和流式输出的聊天服务

## 第 2 周：RAG 系统

- [x] 第 8 天：实现文档上传、解析和清洗
- [x] 第 8 天：实现 Chunk 切分
- [x] 第 8 天：为 Chunk 设计 metadata

- [x] 第 9 天：学习 Embedding
...
- [x] 第 11 天：实现关键词检索 + 向量检索
- [x] 第 11 天：了解 rerank 和查询改写
- [x] 第 11 天：实现答案引用来源

- [x] 第 12 天：处理文档更新、重复内容、无关召回
- [x] 第 12 天：实现“不知道时拒绝回答”
- [x] 第 12 天：实现不同用户的数据隔离

- [x] 第 13 天：准备 30 个 RAG 测试问题
- [x] 第 14 天：记录 Recall@K、引用正确性、响应时间、Token 消耗
- [x] 第 14 天：完成周验收：有引用、可评测的 RAG

## 第 3 周：Function Calling 与 LangGraph Workflow

- [x] 第 15 天：实现真实工具：查询指定实验
- [x] 第 15 天：实现真实工具：对比模型指标
- [x] 第 15 天：所有工具参数必须用 Pydantic 校验

- [x] 第 16 天：实现查询失败案例工具
- [x] 第 16 天：实现计算指标变化工具
- [x] 第 16 天：实现检索实验文档工具
- [x] 第 16 天：禁止模型直接生成任意 SQL
- [x] 第 16 天：工具调用继承用户权限
...
- [x] 第 23 天：完成实验管理页面
- [x] 第 23 天：完成指标对比图表
- [x] 第 23 天：展示工具执行过程和引用来源

- [x] 第 24 天：实现 Prompt Injection 基础防护
- [x] 第 24 天：实现越权工具调用防护
- [x] 第 24 天：实现参数白名单
- [x] 第 24 天：实现日志脱敏
- [x] 第 24 天：实现危险操作二次确认
...
- [x] 第 26 天：评估 RAG 召回质量
- [x] 第 26 天：评估回答事实一致性
- [x] 第 26 天：评估延迟和 Token 成本
- [x] 第 26 天：保存失败案例并写改进方案

- [x] 第 27 天：完成 Docker Compose
- [x] 第 27 天：完成环境变量管理
- [x] 第 27 天：完成数据初始化
- [x] 第 27 天：完成健康检查
- [x] 第 27 天：完善 README 启动说明
